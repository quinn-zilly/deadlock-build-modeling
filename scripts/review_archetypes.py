...
def sheet(meta: dict, purchases: pd.DataFrame) -> str:
    ...
    lines = [
        ...
        f"The seed is {meta['seed']}, so a refit gives the same result.",
        "",
    ...
    for hero_id, m in order:
        ...
        for cluster in m["archetypes"]:
            ...
            if margin >= 1.3:
                confidence = f", family {margin:.1f}x ahead of the next"
            elif margin and named_by_focus:
                confidence = (
                    ", named by what it imbues; the families are too close to call"
                )
            elif margin:
                confidence = ", **no family name**; the families are too close to call"
            else:
                confidence = ""
            ...
            lines += [
                ...
                "",
                f"_Souls by shop tab: {shares}. For reference only; the name "
                "comes from what the items below do._",
                "",
